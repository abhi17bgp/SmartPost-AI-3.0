    ...
    <div className="flex items-center justify-center min-h-screen w-full bg-transparent relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Sign in to SmartPost <span className="text-primary font-medium">AI</span></p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between mb-1.5 align-middle">
              <label className="block text-foreground text-sm font-medium">Password</label>
              <a href="#" onClick={handleForgotPassword} className="text-xs text-primary hover:text-primary/80 focus:outline-none">Forgot password?</a>
            </div>
            <input 
              type="password" 
              required
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-medium py-2.5 rounded-lg transition-colors flex justify-center mt-2 disabled:bg-muted focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background shadow-md shadow-primary/20"
          >
        ...
        <p className="text-center text-muted-foreground text-sm mt-8">
          Don't have an account? <Link to="/register" className="text-primary font-medium hover:text-primary/80 ml-1 transition-colors">Create one</Link>
        </p>
      </motion.div>
    </div>
  );
